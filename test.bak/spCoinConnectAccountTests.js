...
describe("spCoinContract", function () {
  ...
  it("CONNECT ACCOUNT TEST", async function () {
    setLogMode("LOG", true);
    ...
    await connectAccount(RECIPIENT_ACCOUNT_KEY_1);
    await connectAccount(RECIPIENT_ACCOUNT_KEY_2);
    await connectAccount(RECIPIENT_ACCOUNT_KEY_3);
